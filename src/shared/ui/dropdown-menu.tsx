...
export function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ChevronRightIcon className="ltr:ml-auto rtl:mr-auto size-4 ltr:block rtl:hidden" />
      <ChevronLeftIcon className="ltr:ml-auto rtl:mr-auto size-4 ltr:hidden rtl:block" />
    </DropdownMenuPrimitive.SubTrigger>
  )
}

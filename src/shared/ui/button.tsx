  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        outline:
          'border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground active:bg-accent/90 dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
        secondary:
          'bg-secondary text-secondary-foreground shadow-xs hover:bg-secondary/80 active:bg-secondary/90',
        ghost:
          'hover:bg-accent hover:text-accent-foreground active:bg-accent/90 dark:hover:bg-accent/50',
        link: 'text-primary underline-offset-4 hover:underline min-h-0 min-w-0',
      },
      size: {
        default: 'h-11 px-4 py-2 text-base sm:h-9 sm:text-sm has-[>svg]:px-3',
        sm: 'h-9 rounded-md gap-1.5 px-3 text-sm sm:h-8 has-[>svg]:px-2.5',
        lg: 'h-12 rounded-md px-6 text-lg sm:h-10 sm:text-base has-[>svg]:px-4',
        icon: 'size-11 sm:size-9',
        // Mobile-specific sizes
        'mobile-sm': 'h-9 px-3 text-sm',
        'mobile-lg': 'h-14 px-6 text-lg',
      },
      fullWidth: {
        true: 'w-full',
        false: '',
